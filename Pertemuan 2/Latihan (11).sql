...
SELECT emp_id, emp_name, age, name_gol
FROM employees
INNER JOIN golongan ON employees.gol = golongan.gol;

#Dalam bagian ini, kita menggunakan innerjoin untuk mengganti foreign key dengan data dari primary key.
