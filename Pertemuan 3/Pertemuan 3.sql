...
SELECT Orders.OrderID, Customers.CustomerName, Orders.OrderDate FROM Orders INNER JOIN Customers ON CustomerID=Customers.CustomerID;
...
#INSERT INTO SELECT
INSERT INTO Customers (CustomerName, City, Country) SELECT Suppli-erName, City, Country FROM Suppliers;
